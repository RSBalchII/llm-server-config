...
echo "🚀 Installing llama.cpp for micro-nanobot"
echo ""
...
echo ""
echo "Your models:"
ls -lh /data/data/com.termux/files/home/models/*.gguf 2>/dev/null || echo "  No models found yet"
echo ""
echo "Next steps:"
echo "  1) Download a model: ./download-model.sh"
echo "  2) Start micro-nanobot: ./start.sh"
